"""
Django settings for coms project.
...
INSTALLED_APPS = [
    ...
    'allauth',  # Required for Django Allauth
    'allauth.account',  # Required for account management
    'allauth.socialaccount',  # Required for allauth social accounts

    # Authentication and registration
    'dj_rest_auth',  # For RESTful authentication
    'dj_rest_auth.registration',  # For registration endpoints (if needed)

    # Your own apps
    'orders',  # Your custom app for handling orders
]
...
WSGI_APPLICATION = 'coms.wsgi.application'
